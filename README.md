...
## Русские примеры в штатном блоке «Загрузить пример»

Runtime-патч переводит штатный upstream-блок **«Загрузить пример»**: кнопки/chips из интерфейса становятся русскими и вставляют русские заготовки с подходящими параметрами `exaggeration`, `cfg_weight` и `speed_factor`. Отдельный блок **«Русские шаблоны»** больше не добавляется.

Заменяемые presets:

- **⚡ Турбо: Срыв в техподдержке**;
- **⚡ Турбо: Слишком драматичный шеф**;
- **⚡ Турбо: Ведущий конспирологического подкаста**;
- **⚡ Турбо: Первый прыжок с парашютом**;
- **⚡ Турбо: Уставший родитель читает сказку**;
- **⚡ Турбо: Паника в квест-комнате**;
- **⚡ Турбо: Диктор природы пошёл не по плану**;
- **⚡ Турбо: Эмоциональный кинокритик**;
- **⚡ Турбо: Нервный свадебный тост**;
- **Длинный рассказ для проверки фрагментов**;
- **Нуарный монолог детектива**;
- **Рассказчик детской сказки**;
- **Мотивационная речь**;
- **Чтение научной аннотации**;
- **Монолог сказочного злодея**.

Выберите preset прямо в штатном блоке **«Загрузить пример»**, затем нажмите **«Сгенерировать речь»**. Если upstream UI всё равно вставит английский текст, runtime-патч автоматически заменит его русским стартовым текстом.
